        ...
        <form action="{{ route('lab.asset.store') }}" method="POST">
            ...
            <div id="contenedor-filas-enlistar">
                <div class="row-token row-token-enlistar">
                    <div>
                        <select name="asset_type[]" class="select-macro-tipo-activar" onchange="adaptarFilaEcosistema(this)" required>
                    ...
                    <div>
                        <select name="catalog_id[]" class="select-catalogo-activar" onchange="actualizarUnidadFila(this)" disabled required>
                            <option value="">-- {{ __('messages.opt_select') }} --</option>
                        </select>
                    </div>

                    <div>
                        <input type="text" name="custom_name[]" class="input-modelo-activar" placeholder="{{ __('messages.ph_select_category') }}" required>
                    </div>

                    <div style="position: relative; display: flex; align-items: center;">
                        <input type="number" name="quantity_declared[]" class="input-capacidad-activar" placeholder="{{ __('messages.ph_capacity_base') }}" min="1" required>
    ...
    <div id="seccion-perfil-mapa" class="card" style="border: 1px solid rgba(255, 255, 255, 0.04); background: #1c2230; padding: 24px; border-radius: 14px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); margin-top: 25px;">
        <form action="{{ route('lab.update_profile') }}" method="POST" style="margin: 0;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; border-bottom: 1px solid rgba(255,255,255,0.04); padding-bottom: 12px; gap: 20px;">
                ...
                <button type="submit" class="btn-verde-hub">💾 {{ __('messages.btn_save_profile') }}</button>
            </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 12px; border-top: 1px solid rgba(255,255,255,0.02); padding-top: 15px;">
                <div>
                    ...
                    <div style="display: flex; gap: 8px; width: 100%; align-items: center;">
                        ...
                        <button type="button" id="btn-search-map" class="btn-premium btn-verde-hub" style="width: auto;">🔍 {{ __('messages.btn_search_map') }}</button>
                    </div>
                </div>
